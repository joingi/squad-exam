        ...
        <div class="container">
          <div class="form-container" @click.stop>
            ...
            >
              ...
              <input type="email" placeholder="Email" v-model.trim="email" name="email">
            ...
            <transition name="fade">    
              ...
              <span class="switching">Already have an Squad account? <a @click="handler" > Log in </a></span>
            </form>            
          </div>
        </div>
      </div>
    ...
    onSubmit () {
      ...
      if (!this.$v.$invalid && this.chosenLocation !== null) {
        ...
        return axios({
          ...
          .then(tokenCall => {
            var config = {
              headers: { Authorization: 'bearer ' + tokenCall }
            }
            return axios
